...
import (
	...
	"github.com/tzheldibayev/gitcm/internal/ai"
	"github.com/tzheldibayev/gitcm/internal/config"
	"github.com/tzheldibayev/gitcm/internal/git"
)
...
func printUsage() {
	...
	fmt.Println("Usage:")
	fmt.Println("  gitcm config [subcommand]            - Configure the assistant")
	fmt.Println("  gitcm suggest                        - Get a commit suggestion for staged changes")
	fmt.Println("\nRun 'gitcm config' to see configuration options.")
}

func printConfigUsage() {
	fmt.Println("Configuration Commands:")
	fmt.Println("  gitcm config set-openai-key KEY      - Set your OpenAI API key")
	fmt.Println("  gitcm config set-claude-key KEY      - Set your Claude API key")
	fmt.Println("  gitcm config use-provider PROVIDER   - Set active provider (openai or claude)")
}
